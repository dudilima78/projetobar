...
try{
    ...
    $qry = $con->query($sql);
    $item = $qry->fetchAll(PDO::FETCH_OBJ);
    //echo "<pre>";
    //print_r($vendas);
    //die();
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Cardápio</h2></a>
  ...
  <a href="frmmenu.php" class="btn btn-outline-primary">Novo Cadastro</a>
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $item->precocusto ?></td>
            <td><?php echo $item->precovenda ?></td>
            <td><a href="frmmenu.php?iditem=<?php echo $item->iditem ?>" class="btn btn-warning">Editar</a></td>
            <td><a href="frmmenu.php?op=del&iditem=<?php echo  $item->iditem ?>" class="btn btn-danger">Excluir</a></td>
