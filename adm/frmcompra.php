...
Nº do Produto:       <input type="text" name="idestoque"      required     value="<?php echo isset($compra) ? $compra->idestoque : null ?>"><br><br>
Registro do Funcionário:        <input type="text" name="idfuncionario"    required     value="<?php echo isset($compra) ? $compra->idfuncionario : null ?>"><br><br>
