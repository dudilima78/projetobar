...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Cadastro de Funcionários</h2></a>
...
<form method="POST">
Funcionário:      <input type="text"   name="funcionario"   value="<?php echo isset($funcionario) ? $funcionario->funcionario : null ?>"><br><br>
Data de Admissão: <input type="date"   name="dtadmissao"    value="<?php echo isset($funcionario) ? $funcionario->dtadmissao : null ?>"><br><br>
Salário:          <input type="text"   name="salario"       value="<?php echo isset($funcionario) ? $funcionario->salario : null ?>"><br><br>
