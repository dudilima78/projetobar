...
<div class="container-fluid">
    ...
    <a href="frmvenda.php" class="btn btn-outline-primary">Novo Cadastro</a>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo date("d/m/y",strtotime ($venda->dtvenda)) ?></td>
            <td><?php echo $venda->idestoque ?></td>
            <td><?php echo $venda->idfuncionario ?></td>
            <td><?php echo $venda->qtd ?></td>
            <td><a href="frmvenda.php?idvenda=<?php echo $venda->idvenda ?>" class="btn btn-warning">Editar</a></td>
            <td><a href="frmvenda.php?op=del&idvenda=<?php echo  $venda->idvenda ?>" class="btn btn-danger">Excluir</a></td>
