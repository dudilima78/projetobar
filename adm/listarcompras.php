...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><h2>Compras</h2></a>
...
<div class="container-fluid">
    ...
    <a href="frmcompra.php" class="btn btn-outline-primary">Novo Cadastro</a>
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo date("d/m/y",strtotime ($compra->dtcompra)) ?></td>
            <td><?php echo $compra->idestoque ?></td>
            <td><?php echo $compra->idfuncionario ?></td>
            <td><?php echo $compra->qtd ?></td>
            <td><a href="frmcompra.php?idcompra=<?php echo $compra->idcompra ?>" class="btn btn-warning">Editar</a></td>
            <td><a href="frmcompra.php?op=del&idcompra=<?php echo  $compra->idcompra ?>" class="btn btn-danger">Excluir</a></td>
